    ...
    <footer class="main-footer">
        ...
        <?php foreach($postsInView as $post):?>
            <tr>
                ...
                <td><?=$post['id_user']?></td>
                <td>
                    <img src="/public/img/<?=$post['picture_post']?>" alt="">
                </td>
                <td><?=$post['description_post']?></td>
                <td><?=$post['content_post']?></td>
                <td><?=$post['categories_post']?></td>
                <td><?=$post['data_post']?></td>


                <td>
                    <a href="/post/edit/<?=$post['id_post']?>" class="btn btn-warning">
                        <i class="fa fa-pencil"></i>
                    </a>
                    <a href="/post/delete/<?=$post['id_post']?>" class="btn btn-danger" onclick="return confirm('Вы уверены?');">
