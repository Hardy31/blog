                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav text-uppercase pull-left">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="index-2.html">Home Default</a></li>
                                <?php foreach ($categoriesInView as $category):?>
                    ...
                    <article class="single-blog">
                        ...
                        <div class="post-content">
                            ...
                            <div class="entry-content">
                                <p><?php if (strlen($post['content_post'])>200){echo substr($post['content_post'],0,200).'...';}
                                    else{echo $post['content_post'];}?></p>
                            </div>
                            <div class="continue-reading text-center text-uppercase">
                                <a href="../../../post/<?=$post['id_post'];?>">Continue Reading</a>
            ...
            <div class="col-sm-4">
                <div class="kotha-sidebar">
                    ...
                    <aside class="widget widget-popular-post">
                        ...
                        <ul>
                            <li>
                                <a href="#" class="popular-img"><img src=".../../public/assets/images/p-1.jpg" alt="">
                                </a>
                                <div class="p-content">
                            ...
                            <li><a href="#" class="popular-img"><img src="../../public/assets/images/p-2.jpg" alt="">
                                </a>
                                <div class="p-content">
                            ...
                            <li>
                                <a href="#" class="popular-img"><img src="../../public/assets/images/p-3.jpg" alt="">
                                </a>
                                <div class="p-content">
                        ...
                        <ul>
                            <li class="media">
                                <div class="media-left">
                                    <a href="#" class="popular-img"><img src="../../public/assets/recent-1.jpg" alt="">
                                    </a>
                                </div>
                            ...
                            <li class="media">
                                <div class="media-left">
                                    <a href="#" class="popular-img"><img src="../../public/assets/images/recent-2.jpg" alt="">
                                    </a>
                                </div>
                                <div class="latest-post-content">
                            ...
                            <li class="media">
                                <div class="media-left">
                                    <a href="#" class="popular-img"><img src="../../public/assets/images/recent-3.jpg" alt="">
                                    </a>
                                </div>
                                <div class="latest-post-content">
                            ...
                            <li class="media">
                                <div class="media-left">
                                    <a href="#" class="popular-img"><img src="../../public/assets/images/recent-4.jpg" alt="">
                                    </a>
                                </div>
                                <div class="latest-post-content">
                    ...
                    <aside class="widget insta-widget">
                        ...
                        <div class="instagram-feed">
                            <div class="single-instagram">
                                <a href="#">
                                    <img src=".../../public/assets/images/ft-insta-1.jpg" alt="">
                                </a>
                            ...
                            <div class="single-instagram">
                                <a href="#">
                                    <img src="../../public/assets/images/ft-insta-6.jpg" alt="">
                                </a>
                                <div class="insta-overlay">
                                    <div class="insta-meta">
                                        <ul class="list-inline text-center">
                            ...
                            <div class="single-instagram">
                                <a href="#">
                                    <img src="../../public/assets/images/ft-insta-4.jpg" alt="">
                                </a>
                                <div class="insta-overlay">
                                    <div class="insta-meta">
                                        <ul class="list-inline text-center">
                            ...
                            <div class="single-instagram">
                                <a href="#">
                                    <img src="../../public/assets/images/ft-insta-3.jpg" alt="">
                                </a>
                                <div class="insta-overlay">
                                    <div class="insta-meta">
                                        <ul class="list-inline text-center">
                            ...
                            <div class="single-instagram">
                                <a href="#">
                                    <img src="../../public/assets/images/ft-insta-7.jpg" alt="">
                                </a>
                                <div class="insta-overlay">
                                    <div class="insta-meta">
                                        <ul class="list-inline text-center">
                            ...
                            <div class="single-instagram">
                                <a href="#">
                                    <img src="../../public/assets/images/ft-insta-8.jpg" alt="">
                                </a>
                                <div class="insta-overlay">
                                    <div class="insta-meta">
                                        <ul class="list-inline text-center">
                    ...
                    <aside class="widget add-widget">
                        ...
                        <div class="add-image">
                            <a href="#"><img src="../../public/assets/images/add-image.jpg" alt=""></a>
                        </div>
                    </aside>
                </div>
            </div>
...
<div class="container-fluid insta-feed text-center">
    ...
    <div id="footer-instagram" class="footer-insta">
        ...
        <div class="item">
            <div class="single-instagram">
                <a href="#">
                    <img src="../../public/assets/images/ft-insta-2.jpg" alt="">
                </a>
                <div class="insta-overlay">
                    <div class="insta-meta">
                        <ul class="list-inline text-center">
        ...
        <div class="item">
            <div class="single-instagram">
                <a href="#">
                    <img src="../../public/assets/images/ft-insta-5.jpg" alt="">
                </a>
                <div class="insta-overlay">
                    <div class="insta-meta">
                        <ul class="list-inline text-center">
        ...
        <div class="footer-widget-row">
            <div class="footer-widget contact-widget">
                <div class="widget-title">
                    <img src="../../public/assets/images/kotha-white-logo.png" alt="">
                </div>
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item active">
                            <div class="single-review">
                                ...
                                <div class="author-id">
                                    <img src="../../public/assets/images/autho-1r.jpg" alt="">
                                    <div class="author-text">
                                        <h4>Robert Arri</h4>
                        ...
                        <div class="item">
                            <div class="single-review">
                                ...
                                <div class="author-id">
                                    <img src="../../public/assets/images/author.png" alt="">
