...
<header class="kotha-menu marketing-menu">
            ...
            <div class="menu-content">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav text-uppercase pull-left">
                        <li class="dropdown">
                            <a href="index-2.html" class="dropdown-toggle" data-toggle="dropdown"
                               role="button"
                        ...
                        <li><a href="archive-cat.html">Travel</a></li>
                        <li><a href="about-me.html">About me</a></li>
    ...
    <div class="kotha-logo text-center">
        <h1><a href="index-2.html"><img src="../app/views/assets/images/kotha-logo.png" alt="kothPro"></a></h1>
    </div>
</header>
